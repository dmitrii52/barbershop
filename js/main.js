function toNum(str) {
  ...
  const cardAddArr = Array.from(document.querySelectorAll(".header-nav-basket"));
const cartNum = document.querySelector("#header-nav-basket-number");
const cart = document.querySelector("#header-nav-basket");
